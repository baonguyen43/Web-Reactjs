...
const Type12Modal_Mix = ({ detail, type }) => {
  ...
  return (
    <div className="modal-body text-center">
      <ListGroup>
        ...
        <ListGroupItem>
          <p className='mt-2' style={{ fontSize: 18, fontWeight: '500' }}>Repeat the sentence: "{studentChoices.originalSentence}"</p>
...
Type12Modal_Mix.propTypes = {
  detail: PropTypes.instanceOf(Object),
  type: PropTypes.string
}
export default Type12Modal_Mix