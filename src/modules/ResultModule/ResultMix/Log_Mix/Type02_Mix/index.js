...
const Type02Modal_Mix = ({ detail, type }) => {
  ...
  return (
    <div className="modal-body text-center">
      <ListGroup>
        ...
        <ListGroupItem>
          <p className='mt-2' style={{ fontSize: 18, fontWeight: '500' }}>Từ phát âm: {vocabularyQuestion[0].Text}</p>
...
Type02Modal_Mix.propTypes = {
  detail: PropTypes.instanceOf(Object),
  type: PropTypes.string
}
export default Type02Modal_Mix