  ...
  return (
    <div className="modal-body text-center">
      ...
      <Rate
        ...
        allowHalf
      />
      <p className='text-red mt-2' style={{ fontSize: 18, fontWeight: '500' }}>
      ...
      <p className='text-red' style={{ fontSize: 16, fontWeight: '500' }}>Correct Answer: {studentChoices.example}</p>
    
    </div>
  )
}

Type14Modal.propTypes = {
  detail: PropTypes.instanceOf(Object),
  type: PropTypes.string
}
export default Type14Modal