  ...
  return (
    <div className="modal-body text-center">
      <ListGroup>
        ...
        <ListGroupItem>
          <p className='mt-2' style={{ fontSize: 18, fontWeight: '500' }}>Từ phát âm: {detail.vocabularyQuestion[0].text}</p>
...
Type02Modal.propTypes = {
  detail: PropTypes.instanceOf(Object),
  type: PropTypes.string
}
export default Type02Modal