  ...
  return (
    <div className="modal-body text-center">
      ...
      <Rate
        ...
        allowHalf
      />
      <p className='text-red mt-2' style={{ fontSize: 18, fontWeight: '500' }}>Từ "{detail.vocabularyQuestion[0].text_VN}" trong tiếng anh là:</p>
...
Type05Modal.propTypes = {
  detail: PropTypes.instanceOf(Object),
  type: PropTypes.string
}
export default Type05Modal