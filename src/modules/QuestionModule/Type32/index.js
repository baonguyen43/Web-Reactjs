...
import { Row, Col, Button, Card, CardTitle, CardText, CardImg, CardBody } from 'reactstrap';
...
export default class Type32 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      question: [],
        ...
        {question.isPlayed ? (
          <div style={{ fontWeight: 'bold' }}>Bạn đã hoàn thành câu hỏi này, vui lòng tiếp tục câu tiếp theo</div>
            ...
            <div className='text-center'>
              ...
              <p style={{ color: '#5d6670', marginTop: 15,fontSize:15 }}>Lưu ý: Bạn hãy dành thời gian chuẩn bị ý chính cho bài nói trước khi bắt đầu ghi âm!</p>
            </div>
          )}
        {resultRecord && (
          <div>
  ...
  render = () => {
    ...
    return (
      <Row className={name}>
        <Col className='mt-4'>
          <Card>
            {question.imageUrl && <CardImg alt="..." src={question.imageUrl} top />}
            <CardBody>
