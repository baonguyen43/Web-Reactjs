...
import { Button, Row, Col, ListGroup, ListGroupItem, Card, CardBody, CardImg } from 'reactstrap';
...
const name = 'bg-default justify-content-md-center align-items-center mt-4';
...
class Type01 extends React.Component {
  ...
  render() {
    const { disabledBack, disabledNext, question, onBack } = this.props;
